...
> addGlobalAttributesToProject(id, javaUtilUUID)
...
try {
    apiInstance.addGlobalAttributesToProject(id, javaUtilUUID)
} catch (e: ClientException) {
    println("4xx response calling ProjectsApi#addGlobalAttributesToProject")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling ProjectsApi#addGlobalAttributesToProject")
    e.printStackTrace()
}
```
...
> kotlin.collections.List&lt;FailureCategoryApiResult&gt; apiV2ProjectsIdFailureClassesGet(id, isDeleted)
...
try {
    val result : kotlin.collections.List<FailureCategoryApiResult> = apiInstance.apiV2ProjectsIdFailureClassesGet(id, isDeleted)
    println(result)
} catch (e: ClientException) {
...
[**kotlin.collections.List&lt;FailureCategoryApiResult&gt;**](FailureCategoryApiResult.md)
...
try {
    val result : ProjectApiResult = apiInstance.createProject(createProjectApiModel)
    println(result)
} catch (e: ClientException) {
...
> kotlin.collections.List&lt;AutoTestNamespaceApiResult&gt; getAutoTestsNamespaces(id)
...
val id : kotlin.String = id_example // kotlin.String | Project internal (UUID) or global (integer) identifier
try {
    val result : kotlin.collections.List<AutoTestNamespaceApiResult> = apiInstance.getAutoTestsNamespaces(id)
    println(result)
} catch (e: ClientException) {
...
[**kotlin.collections.List&lt;AutoTestNamespaceApiResult&gt;**](AutoTestNamespaceApiResult.md)
