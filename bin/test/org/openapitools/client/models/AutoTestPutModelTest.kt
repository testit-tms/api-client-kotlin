...
class AutoTestPutModelTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of AutoTestPutModel
        //val modelInstance = AutoTestPutModel()
        ...
        // to test the property `id` - Used for search autotest. If value is null or equals Guid mask filled with zeros, search will be executed using ExternalId
        should("test id") {
            // uncomment below to test the property
            //modelInstance.id shouldBe ("TODO")
        }

        // to test the property `workItemIdsForLinkWithAutoTest`
