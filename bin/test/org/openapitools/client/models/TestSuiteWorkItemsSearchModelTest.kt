...
class TestSuiteWorkItemsSearchModelTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of TestSuiteWorkItemsSearchModel
        //val modelInstance = TestSuiteWorkItemsSearchModel()

        // to test the property `tagNames` - Collection of tags
        ...
        // to test the property `nameOrId` - Name or identifier (UUID) of work item
        should("test nameOrId") {
            // uncomment below to test the property
            //modelInstance.nameOrId shouldBe ("TODO")
        }

        // to test the property `includeIds` - Collection of identifiers of work items which need to be included in result regardless of filtering
        should("test includeIds") {
            // uncomment below to test the property
            //modelInstance.includeIds shouldBe ("TODO")
        }

        // to test the property `excludeIds` - Collection of identifiers of work items which need to be excluded from result regardless of filtering
        should("test excludeIds") {
            // uncomment below to test the property
            //modelInstance.excludeIds shouldBe ("TODO")
        }
