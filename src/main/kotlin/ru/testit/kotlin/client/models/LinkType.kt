...
enum class LinkType(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ru.testit.kotlin.client.models.LinkType) "$data" else null

        /**
         * Returns a valid [LinkType] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ru.testit.kotlin.client.models.LinkType? = data?.let {
