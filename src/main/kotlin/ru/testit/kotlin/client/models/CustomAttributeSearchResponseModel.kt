...
data class CustomAttributeSearchResponseModel (

    @Json(name = "workItemUsage")
    val workItemUsage: kotlin.collections.List<ProjectShortestModel>,

    @Json(name = "testPlanUsage")
    val testPlanUsage: kotlin.collections.List<ProjectShortestModel>,
