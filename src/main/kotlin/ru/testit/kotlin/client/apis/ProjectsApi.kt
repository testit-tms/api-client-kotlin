...
import ru.testit.kotlin.client.models.AutoTestNamespaceApiResult
...
import ru.testit.kotlin.client.models.DetailedProjectApiResult
...
import ru.testit.kotlin.client.models.ProjectShortApiResultIReply
...
open class ProjectsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun addGlobalAttributesToProject(id: kotlin.String, javaUtilUUID: kotlin.collections.Set<java.util.UUID>? = null) : Unit {
        val localVarResponse = addGlobalAttributesToProjectWithHttpInfo(id = id, javaUtilUUID = javaUtilUUID)
    ...
    fun addGlobalAttributesToProjectWithHttpInfo(id: kotlin.String, javaUtilUUID: kotlin.collections.Set<java.util.UUID>?) : ApiResponse<Unit?> {
        val localVariableConfig = addGlobalAttributesToProjectRequestConfig(id = id, javaUtilUUID = javaUtilUUID)
    ...
    /**
     * To obtain the request config of the operation addGlobalAttributesToProject
     *
     * @param id Project internal (UUID) or global (integer) identifier
     * @param javaUtilUUID  (optional)
     * @return RequestConfig
     */
    fun addGlobalAttributesToProjectRequestConfig(id: kotlin.String, javaUtilUUID: kotlin.collections.Set<java.util.UUID>?) : RequestConfig<kotlin.collections.Set<java.util.UUID>> {
     ...
     * @return kotlin.collections.List<FailureCategoryApiResult>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    fun apiV2ProjectsIdFailureClassesGet(id: kotlin.String, isDeleted: kotlin.Boolean? = null) : kotlin.collections.List<FailureCategoryApiResult> {
        @Suppress("DEPRECATION")
        val localVarResponse = apiV2ProjectsIdFailureClassesGetWithHttpInfo(id = id, isDeleted = isDeleted)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<FailureCategoryApiResult>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param id Unique or global ID of the project
     * @param isDeleted  (optional)
     * @return ApiResponse<kotlin.collections.List<FailureCategoryApiResult>?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun apiV2ProjectsIdFailureClassesGetWithHttpInfo(id: kotlin.String, isDeleted: kotlin.Boolean?) : ApiResponse<kotlin.collections.List<FailureCategoryApiResult>?> {
        @Suppress("DEPRECATION")
        val localVariableConfig = apiV2ProjectsIdFailureClassesGetRequestConfig(id = id, isDeleted = isDeleted)

        return request<Unit, kotlin.collections.List<FailureCategoryApiResult>>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun apiV2ProjectsSearchPost(skip: kotlin.Int? = null, take: kotlin.Int? = null, orderBy: kotlin.String? = null, searchField: kotlin.String? = null, searchValue: kotlin.String? = null, projectsFilterModel: ProjectsFilterModel? = null) : kotlin.collections.List<ProjectApiResult> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun apiV2ProjectsSearchPostWithHttpInfo(skip: kotlin.Int?, take: kotlin.Int?, orderBy: kotlin.String?, searchField: kotlin.String?, searchValue: kotlin.String?, projectsFilterModel: ProjectsFilterModel?) : ApiResponse<kotlin.collections.List<ProjectApiResult>?> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun apiV2ProjectsShortsPost(getShortProjectsApiModel: GetShortProjectsApiModel? = null) : ProjectShortApiResultIReply {
        val localVarResponse = apiV2ProjectsShortsPostWithHttpInfo(getShortProjectsApiModel = getShortProjectsApiModel)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as ProjectShortApiResultIReply
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun apiV2ProjectsShortsPostWithHttpInfo(getShortProjectsApiModel: GetShortProjectsApiModel?) : ApiResponse<ProjectShortApiResultIReply?> {
        val localVariableConfig = apiV2ProjectsShortsPostRequestConfig(getShortProjectsApiModel = getShortProjectsApiModel)

        return request<GetShortProjectsApiModel, ProjectShortApiResultIReply>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation apiV2ProjectsShortsPost
     *
     * @param getShortProjectsApiModel  (optional)
     * @return RequestConfig
     */
    fun apiV2ProjectsShortsPostRequestConfig(getShortProjectsApiModel: GetShortProjectsApiModel?) : RequestConfig<GetShortProjectsApiModel> {
        val localVariableBody = getShortProjectsApiModel
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Content-Type"] = "application/json"
        localVariableHeaders["Accept"] = "application/json"
    ...
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun getAllProjects(isDeleted: kotlin.Boolean? = null, projectName: kotlin.String? = null, skip: kotlin.Int? = null, take: kotlin.Int? = null, orderBy: kotlin.String? = null, searchField: kotlin.String? = null, searchValue: kotlin.String? = null) : kotlin.collections.List<ProjectApiResult> {
        @Suppress("DEPRECATION")
    ...
    @Throws(IllegalStateException::class, IOException::class)
    @Deprecated(message = "This operation is deprecated.")
    fun getAllProjectsWithHttpInfo(isDeleted: kotlin.Boolean?, projectName: kotlin.String?, skip: kotlin.Int?, take: kotlin.Int?, orderBy: kotlin.String?, searchField: kotlin.String?, searchValue: kotlin.String?) : ApiResponse<kotlin.collections.List<ProjectApiResult>?> {
        @Suppress("DEPRECATION")
        ...
        return request<Unit, kotlin.collections.List<ProjectApiResult>>(
            localVariableConfig
        )
    }
     ...
     * @param id Project internal (UUID) or global (integer) identifier
     * @return kotlin.collections.List<AutoTestNamespaceApiResult>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     * @throws UnsupportedOperationException If the API returns an informational or redirection response
     * @throws ClientException If the API returns a client error response
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getAutoTestsNamespaces(id: kotlin.String) : kotlin.collections.List<AutoTestNamespaceApiResult> {
        val localVarResponse = getAutoTestsNamespacesWithHttpInfo(id = id)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<AutoTestNamespaceApiResult>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     *   Use case    User sets project internal or global identifier and runs method execution    System search project    System search all autotest related to the project    System returns array of autotest with namespaces and classnames (listed in response)
     * @param id Project internal (UUID) or global (integer) identifier
     * @return ApiResponse<kotlin.collections.List<AutoTestNamespaceApiResult>?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getAutoTestsNamespacesWithHttpInfo(id: kotlin.String) : ApiResponse<kotlin.collections.List<AutoTestNamespaceApiResult>?> {
        val localVariableConfig = getAutoTestsNamespacesRequestConfig(id = id)

        return request<Unit, kotlin.collections.List<AutoTestNamespaceApiResult>>(
            localVariableConfig
        )
    }
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getProjectById(id: kotlin.String) : DetailedProjectApiResult {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getProjectByIdWithHttpInfo(id: kotlin.String) : ApiResponse<DetailedProjectApiResult?> {
