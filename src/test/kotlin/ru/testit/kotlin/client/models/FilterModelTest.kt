...
class FilterModelTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of FilterModel
        //val modelInstance = FilterModel()
        ...
        // to test the property `fieldsToShow`
        should("test fieldsToShow") {
            // uncomment below to test the property
            //modelInstance.fieldsToShow shouldBe ("TODO")
        }
