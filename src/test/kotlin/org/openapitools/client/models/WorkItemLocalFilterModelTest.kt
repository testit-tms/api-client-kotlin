...
class WorkItemLocalFilterModelTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of WorkItemLocalFilterModel
        //val modelInstance = WorkItemLocalFilterModel()
